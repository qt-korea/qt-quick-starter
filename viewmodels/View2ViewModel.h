...
class View2ViewModel : public ViewModelBase
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    explicit View2ViewModel(const AppServices &services,
                            QObject           *parent = nullptr);

    QString pageName() const override { return QStringLiteral("View2"); }
